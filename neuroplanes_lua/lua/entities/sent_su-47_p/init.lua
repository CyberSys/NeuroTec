...
ENT.Model = "models/hawx/planes/su-47 berkut.mdl"
//Speed Limits
ENT.MaxVelocity = 1.8 * 2710
ENT.MinVelocity = 0
...
ENT.MachineGunOffset = Vector( 293, -13, 126 )
...
ENT.ThrusterPos = {}
ENT.ThrusterPos[1] = Vector( -383, 30, 99 )
ENT.ThrusterPos[2] = Vector( -383, -30, 99 )

function ENT:SpawnFunction( ply, tr)

	local SpawnPos = tr.HitPos + tr.HitNormal * 100
	local ent = ents.Create( "sent_su-47_p" )
	ent:SetPos( SpawnPos )
	ent:Spawn()
	ent:Activate()
...
function ENT:Initialize()
	...
	*/
	...
	self.Trails = {}
	self.TrailPos = {}
	self.TrailPos[1] = Vector( -68, -317, 110 )
	self.TrailPos[2] = Vector( -68, 317, 110 )
