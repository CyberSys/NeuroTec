...
ENT.PrintName	= "F-18 HARV"
ENT.Model = "models/hawx/planes/f-18 harv.mdl"
//Speed Limits
...
function ENT:SpawnFunction( ply, tr)
	...
	local ent = ents.Create( "sent_f-18harv_p" )
	ent:SetPos( SpawnPos )
	ent:Spawn()
	ent:Activate()
