...
ENT.PrintName = "A-10 Thunderbolt"
...
function ENT:SpawnFunction( ply, tr)
	...
	local ent = ents.Create( "sent_a-10_p" )
	ent:SetPos( SpawnPos )
	ent:Spawn()
	ent:Activate()
	...
	*/
	...
	self.Armament = {
					...
					{ 
						...
						Damage = 250, // Impact damage, Optional for Laser Guided
	...
	self.Trails = {}
	self.TrailPos = {}
	self.TrailPos[1] = Vector( -76, -335, 104 )
	self.TrailPos[2] = Vector( -75, 335, 104 )
