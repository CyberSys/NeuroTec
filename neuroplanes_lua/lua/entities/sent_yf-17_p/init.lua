...
ENT.PrintName	= "YF-17 Cobra"
ENT.Model = "models/hawx/planes/yf-17 cobra.mdl"
//Speed Limits
...
function ENT:SpawnFunction( ply, tr)
	...
	local ent = ents.Create( "sent_yf-17_p" )
	ent:SetPos( SpawnPos )
	ent:Spawn()
	ent:Activate()
