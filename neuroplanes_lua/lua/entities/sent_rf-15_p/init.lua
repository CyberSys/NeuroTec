...
ENT.PrintName	= "RF-15 PeakEagle"
ENT.Model = "models/hawx/planes/rf-15 peakeagle.mdl"
//Speed Limits
...
ENT.MachineGunOffset = Vector( 155, 54, 89 )
...
function ENT:SpawnFunction( ply, tr)
	...
	local ent = ents.Create( "sent_rf-15_p" )
	ent:SetPos( SpawnPos )
	ent:Spawn()
	ent:Activate()
...
function ENT:Initialize()
	...
	*/
	...
	self.Trails = {}
	self.TrailPos = {}
	self.TrailPos[1] = Vector( -358, -161, 65 )
	self.TrailPos[2] = Vector( -358, 161, 65 )
...
function ENT:PrimaryAttack()
	...
	if ( !IsValid( self.Pilot ) ) then
 	...
 	local bullet = {} 
 	bullet.Num 		= 1
 	bullet.Src 		= self.Weapon:GetPos() + self.Weapon:GetForward() * 355
