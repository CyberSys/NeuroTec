include('shared.lua')
language.Add("npc_a10thunderbolt", "A-10 Thunderbolt")
...
function ENT:Draw()
	...
	local pos = {}
	pos[1] = self:GetPos() + self:GetForward() * -200 + self:GetRight() * -56 + self:GetUp() * 120 
	pos[2] = self:GetPos() + self:GetForward() * -200 + self:GetRight() * 56 + self:GetUp() * 120 
