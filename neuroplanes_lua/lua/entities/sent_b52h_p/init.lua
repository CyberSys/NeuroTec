...
ENT.Model = "models/hawx/planes/b-52h stratofortress.mdl"
//Speed Limits
...
function ENT:SpawnFunction( ply, tr)
	...
	local ent = ents.Create( "sent_b52h_p" )
	ent:SetPos( SpawnPos )
	ent:Spawn()
	ent:Activate()
...
function ENT:Initialize()
	...
	*/
	...
	self.Armament = {
					...
					{ 
						PrintName = "AGM-142 Torpedo"		,		 			// print name, used by the interface
						Mdl = "models/hawx/weapons/agm-142.mdl",  						// model, visual only
						DisplayModel = "models/hawx/weapons/agm-142.mdl",  				// model, used when creating the object
						Pos = Vector( 150, 0, -60 ), 							// Pos, Hard point location on the plane fuselage.
						Ang = Angle( 0, 0, 0), 									// Ang, object angle
						Type = "HomingTorpedo", 										// Type, used when creating the object
						...
						Class = "sent_a2s_torpedo"							// the object that will be created.
					}; 					
