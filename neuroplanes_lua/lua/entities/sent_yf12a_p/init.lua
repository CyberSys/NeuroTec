...
ENT.PrintName	= "Lockheed YF-12"
ENT.Model = "models/hawx/planes/yf-12a.mdl"
...
function ENT:SpawnFunction( ply, tr)
	...
	local ent = ents.Create( "sent_yf12a_p" )
	ent:SetPos( SpawnPos )
	ent:Spawn()
	ent:Activate()
...
function ENT:Initialize()
	...
	self.Armament = {
					...
					{ 
						...
						Damage = 400, // Impact damage, Optional for Laser Guided
						Radius = 3024 // Blast Radius
					};
				}
