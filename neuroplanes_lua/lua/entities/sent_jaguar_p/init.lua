...
ENT.PrintName	= "Jaguar Sepecat"
ENT.Model = "models/hawx/planes/jaguar sepecat.mdl"
//Speed Limits
...
function ENT:SpawnFunction( ply, tr)
	...
	local ent = ents.Create( "sent_jaguar_p" )
	ent:SetPos( SpawnPos )
	ent:Spawn()
	ent:Activate()
...
function ENT:Initialize()
	...
	*/
	...
	self.Trails = {}
	self.TrailPos = {}
	self.TrailPos[1] = Vector( -130, -172, 82 )
	self.TrailPos[2] = Vector( -130, 172, 82 )
