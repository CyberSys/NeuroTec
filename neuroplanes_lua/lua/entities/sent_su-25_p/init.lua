...
ENT.PrintName	= "Su-25 Frogfoot"
ENT.Model = "models/hawx/planes/su-25 frogfoot.mdl"
//Speed Limits
ENT.MaxVelocity = 1.8 * 950
ENT.MinVelocity = 0
...
function ENT:SpawnFunction( ply, tr)
	...
	local ent = ents.Create( "sent_su-25_p" )
	ent:SetPos( SpawnPos )
	ent:Spawn()
	ent:Activate()
