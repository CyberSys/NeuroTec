...
ENT.PrintName	= "F/A-18E SuperHornet"
ENT.Model = "models/hawx/planes/fa-18e superhornet.mdl"
//Speed Limits
...
function ENT:SpawnFunction( ply, tr)
	...
	local ent = ents.Create( "sent_fa-18e_p" )
	ent:SetPos( SpawnPos )
	ent:Spawn()
	ent:Activate()
