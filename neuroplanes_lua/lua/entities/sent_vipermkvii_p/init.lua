...
ENT.PrintName	= "Colonial Viper Mk-VII"
ENT.Model = "models/fsx/vipermkvii/vipermkvii.mdl"
//Speed Limits
...
function ENT:SpawnFunction( ply, tr)
	...
	local ent = ents.Create( "sent_ViperMkVIi_p" )
	ent:SetPos( SpawnPos )
	ent:Spawn()
	ent:Activate()
...
function ENT:Initialize()
	...
	*/
    ...
    local minipos = { Vector( -51, 144, -73), Vector( -48, -143, -73), Vector( -119, 0, 48) }
	self.Miniguns = {}
	...
	self.MinigunMaxIndex = #self.Miniguns
		...
		self.FlameSprR:SetPos( self:GetPos() + self:GetForward() * -228 + self:GetRight() * 18 + self:GetUp() * -35  )
		...
		self.FlameSprR:SetKeyValue( "model", "sprites/physcannon_bluecore1b.vmt" )
		...
		self.FlameSprL:SetPos( self:GetPos() + self:GetForward() * -228 + self:GetRight() * -21 + self:GetUp() * -35  )
		...
		self.FlameSprL:SetKeyValue( "model", "sprites/physcannon_bluecore1b.vmt" )
		...
		self.FlameSprT:SetPos( self:GetPos() + self:GetForward() * -229 + self:GetRight() * -1 + self:GetUp() * 0  )
		self.FlameSprT:SetAngles( self:GetAngles() )
		self.FlameSprT:SetKeyValue( "spawnflags", 1 )
		self.FlameSprT:SetKeyValue( "renderfx", 0 )
		self.FlameSprT:SetKeyValue( "scale", 0.25 )
		...
		self.FlameSprT:SetKeyValue( "model", "sprites/physcannon_bluecore1b.vmt" )
		...
		self.FlameTrailR:SetPos( self:GetPos() + self:GetForward() * -228 + self:GetRight() * 18 + self:GetUp() * -35  )
		...
		self.FlameTrailR:SetKeyValue( "rendercolor", "200 255 255" )
		...
		self.FlameTrailL:SetPos( self:GetPos() + self:GetForward() * -228 + self:GetRight() * -21 + self:GetUp() * -35  )
		...
		self.FlameTrailL:SetKeyValue( "rendercolor", "200 255 255" )
		...
		self.FlameTrailT:SetPos( self:GetPos() + self:GetForward() * -229 + self:GetRight() * -1 + self:GetUp() * 0  )
		...
		self.FlameTrailT:SetKeyValue( "rendercolor", "200 255 255" )
...
function ENT:OnTakeDamage(dmginfo)
	...
	if ( self.HealthVal < self.InitialHealth * 0.15 && !self.Burning ) then
		...
		local pos = { Vector( -228, -1, 0 ), Vector( -229, 18, -35 ), Vector( -229, -21, -35 ) }
...
function ENT:PrimaryAttack()
	...
	self:EmitSound( "minigun_shoot.wav", 510, math.random( 100, 130 ) )
