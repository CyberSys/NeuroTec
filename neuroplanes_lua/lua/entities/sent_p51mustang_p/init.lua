...
ENT.Model = "models/fsx/warbirds/p51.mdl"
-- Speed Limits
ENT.MaxVelocity = 1.8 * 800
ENT.MinVelocity = 0
...
function ENT:SpawnFunction( ply, tr)
	...
	local ent = ents.Create( "sent_p51mustang_p" )
	ent:SetPos( SpawnPos )
	ent:Spawn()
	ent:Activate()
...
function ENT:Initialize()
	...
	self.Armament = {
					...
					{ 
						...
						Pos = Vector( 54, -85, 24 ), 							--  Pos, Hard point location on the plane fuselage.
	...
	self.Trails = {}
	self.TrailPos = {}
	self.TrailPos[1] = Vector( -5,201, 35)
	self.TrailPos[2] = Vector( -5, -201, 35 )
	...
	local minipos = {
						Vector( 40, -118, 26), Vector( 40, -106, 25), Vector( 40, -94, 24 ),
						Vector( 40, 118, 26), Vector( 40, 106, 25), Vector( 40, 94, 24 );

					}
					
	self.Miniguns = {}
	-- 58.8425 -114.2156 27.2067
-- 58.4922 -106.9013 25.5852
-- 58.4491 -94.2473 24.0364
	...
	local PropellerPos = Vector( 152, 0, 46)
	self.Propeller = ents.Create("prop_physics")
	self.Propeller:SetPos( self:LocalToWorld( PropellerPos ) )
	self.Propeller:SetModel( "models/fsx/warbirds/p51propeler.mdl" )
...
-- 	wheelpos[2] = Vector( 0, 0, 0 )
	wheelpos[1] = Vector( 47, -70, -13 )
	wheelpos[2] = Vector( 47, 70, -13 )
	wheelpos[3] = Vector( 47, -70, -13 )
	wheelpos[4] = Vector( 47, 70, -13 )
	local gearpos = {}
	gearpos[1] = Vector( 56, -76, 23 )
	gearpos[2] = Vector( 56, 76, 23 )
...
function ENT:Use(ply,caller)
	...
	if ( !self.IsFlying && !IsValid( self.Pilot ) ) then 
		...
		self.PilotModel = self:SpawnPilotModel( Vector( 12,0,35 ), Angle( -15,0,0 ) )
...
function ENT:PhysicsSimulate( phys, deltatime )
	...
	if ( self.IsFlying /*&& !stallang */) then
		...
		-- /* End of test*/
		local up = Vector( 0,0, -350 + ( self:GetVelocity():Length() / 3.8 ) )
