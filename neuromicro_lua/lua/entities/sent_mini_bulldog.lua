...
ENT.Gauges = {
		...
		Clock = {
			Pos = Vector( 35, 11.5, -9.0 ),
			Ang = Angle(),
			Scale = 0.02
		};
		Altimeter = {
			Pos = Vector( 35, 0, -12.5 ),
			Ang = Angle(),
			Scale = 0.025
		};
		Airspeed = {
...
ENT.TailLiftMultiplier = 50        -- Wing Mass / Mult * Velocity -- lift coefficient 
ENT.WingLiftMultiplier = 60		    -- tail lift coefficient
ENT.MaxVelocity = 1.9 * 460			-- Top speed in km/h
...
ENT.WheelMass = 2050				-- Wheel weight
-- ENT.BankForceDivider = 0.5
ENT.PitchForceDivider = 3.75
