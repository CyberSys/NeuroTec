...
ENT.HelicopterCorrectionalVector = Vector( -3.4,0,-0 )
...
ENT.Gauges = {
		AttitudeIndicator = {
			Pos = Vector( 17, 5.85, 0.2 ),
			Ang = Angle(),
			Scale = 0.015
		};
		Compass = {
			Pos = Vector( 17, 0.25, -1.25 ),
			Ang = Angle(),
			Scale = 0.005
		};
		VSpeed = {
			Pos = Vector( 17, -1.5, -2.2 ),
			Ang = Angle(),
			Scale = 0.0075
		};
		Clock = {
			Pos = Vector( 17, -2.2, -1.25 ),
			Ang = Angle(),
			Scale = 0.005
		};		
		Airspeed = {
			Pos = Vector( 17, .65, -2.2 ),
			Ang = Angle(),
			Scale = 0.008
		};
		Altimeter = {
			Pos = Vector( 17, -1, -1.25),
			Ang = Angle(),
			Scale = 0.005
		};
		Throttle = {
			Pos = Vector( 17, 7.1, -2.5 ),
			Ang = Angle(),
			Scale = 0.0125
		};
		EngineTemp = {
...
ENT.TailRotorPos = Vector( -63, -1.5, 8.5 ) * SCALE
...
ENT.Model 			= "models/hoffa/neuroplanes/china/z10w/body.mdl"
ENT.TailModel 		= "models/hoffa/neuroplanes/china/z10w/tail.mdl"
ENT.WingModels 		= { "models/hoffa/neuroplanes/china/z10w/wing_l.mdl", 
						"models/hoffa/neuroplanes/china/z10w/wing_r.mdl" }
...
ENT.MinigunPos = {  Vector( 32, 0, -15.5 )  * SCALE }
...
ENT.CockpitPosition = Vector( 10, 0, 2 ) * SCALE
...
ENT.Armament = {
					{ 
						...
						Pos =  Vector(0, -17, -15.5 ) * SCALE , 							-- Pos, Hard point location on the plane fuselage.
					...
					{ 
						PrintName = "Air-to-Air",
						Mdl ="models/starchick971/hawx/weapons/aim-9 sidewinder.mdl" ,
						Pos =  Vector(0, -17, -12 ) * SCALE , 							-- Pos, Hard point location on the plane fuselage.
						Ang = Angle( 0, 0, 0 ), 								-- Ang, object angle
						Type = "Homing",						-- Type, used when creating the object
						BurstSize = 1,
						Cooldown = 7, 										-- Cooldown between weapons
					...
					{ 
						PrintName = "Air-to-Air",
						Mdl ="models/starchick971/hawx/weapons/aim-9 sidewinder.mdl" ,
						Pos =  Vector(0, -21, -15.5 )  * SCALE, 							-- Pos, Hard point location on the plane fuselage.
						Ang = Angle( 0, 0, 0 ), 								-- Ang, object angle
						Type = "Homing",						-- Type, used when creating the object
						BurstSize = 1,
						Cooldown = 7, 										-- Cooldown between weapons
					...
					{ 
						PrintName = "Air-to-Air",
						Mdl ="models/starchick971/hawx/weapons/aim-9 sidewinder.mdl" ,
						Pos =  Vector(0, -21, -12 )  * SCALE, 							-- Pos, Hard point location on the plane fuselage.
						Ang = Angle( 0, 0, 0 ), 								-- Ang, object angle
						Type = "Homing",						-- Type, used when creating the object
						BurstSize = 1,
						Cooldown = 7, 										-- Cooldown between weapons
