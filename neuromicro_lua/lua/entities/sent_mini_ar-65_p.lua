...
ENT.Gauges = {
		...
		EngineTemp = {
			Pos = Vector( 35, 3.8, -13 ),
			Ang = Angle(),
			Scale = 0.02
		};
		Airspeed = {
			Pos = Vector( 35, 11.5, -11 ),
			Ang = Angle(),
			Scale = 0.025
		};		
		FuelCounter = {
			Pos = Vector( 35, 18.5, -11 ),
			Ang = Angle(),
			Scale = 0.025
		};
		Throttle = {
			Pos = Vector( 35, 1.2, -7.0 ),
			Ang = Angle(),
			Scale = 0.04
		};
	}
...
ENT.TailLiftMultiplier = 25.5        -- Wing Mass / Mult * Velocity -- lift coefficient 
ENT.WingLiftMultiplier = 60		    -- tail lift coefficient
ENT.MaxVelocity = 1.9 * 450			-- Top speed in km/h
