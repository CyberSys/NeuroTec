...
ENT.Gauges = {
		...
		Compass = {
			Pos = Vector( 15, 4.5, 2.25 ),
			Ang = Angle(),
			Scale = 0.008
		};
		VSpeed = {
			Pos = Vector( 18, 2.5, 4.5 ),
			Ang = Angle(),
			Scale = 0.01
		};
		Clock = {
		...
		Throttle = {
			Pos = Vector( 18, -2.25, 5.0 ),
			Ang = Angle(),
			Scale = 0.02
		};
		EngineTemp = {
			Pos = Vector( 18, -0.9, 1.55 ),
			Ang = Angle(),
			Scale = 0.01
		};
...
ENT.PitchValue = 12.5					-- how fast we rise / dive
...
ENT.MaxVelocity = 1.9 * 850			-- Top speed in km/h // Heavy gun :D
...
ENT.BankForce = 690					-- Aileron / banking force Unit/s
