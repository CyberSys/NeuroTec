...
ENT.Model 			= "models/sillirion/stargate/deathglider_body.mdl"
ENT.TailModel 		= "models/starchick971/neuroplanes/american/fa-22 raptor_nozzle_l.mdl"
ENT.WingModels 		= { "models/sillirion/Stargate/deathglider_leftwing.mdl", 
						"models/sillirion/Stargate/deathglider_rightwing.mdl" }
ENT.PropellerModels 	= { "models/props_phx2/garbage_metalcan001a.mdl","models/props_phx2/garbage_metalcan001a.mdl" }

ENT.TailPos			= Vector( -0, 0, 25)
ENT.WingPositions 	= {  Vector( 0,0,0 ), 
						Vector( 0,0,0 ) }
						
-- ENT.PropellerAttachedToWings = true 
ENT.PropellerPos 	= { Vector( -25, -45, 35 ), Vector( -25, 45,35  ) }
...
ENT.RudderMultiplier = 97 			-- how much we turn 
ENT.PitchValue = 15					-- how fast we rise / dive
...
ENT.TailLiftMultiplier = 952225		-- Wing Mass / Mult * Velocity -- lift coefficient 
ENT.WingLiftMultiplier = 52225			-- tail lift coefficient
...
if( SERVER ) then
	...
	function ENT:SpawnFunction( ply, tr, class )
		local SpawnPos =  ply:GetPos() + ply:GetUp() * 5200
	...
	function ENT:PhysicsSimulate( phys, deltatime ) self:MicroPhysics( phys, deltatime ) 
		...
		-- end 
		-- self:GetPhysicsObject():AddAngleVelocity( Vector( 0, -25.5, 0.0 )  * 1.0 * ( self.CurVelocity  / self.MaxVelocity ) ) 
