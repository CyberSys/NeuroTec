...
ENT.Gauges = {
		...
		VSpeed = {
			Pos = Vector( 35, 1.5, -9.5 ),
			Ang = Angle(),
			Scale = 0.025
		};
		Clock = {
			Pos = Vector( 35, -5.75, -8.350 ),
			Ang = Angle(),
			Scale = 0.015
		};
		Altimeter = {
			Pos = Vector( 35, 14.5, -9.5 ),
			Ang = Angle(),
			Scale = 0.025
		};
		Airspeed = {
		...
		EngineTemp = {
			Pos = Vector( 35, 1.5, -16 ),
			Ang = Angle(),
			Scale = 0.025
		};
		Throttle = {
			Pos = Vector( 35, -3, -10.5 ),
			Ang = Angle(),
			Scale = 0.04
		};
	}
...
ENT.PassengerPos = Vector( 0, -.1,  6.3 )
...
ENT.Armament = {
					{ 
						...
						Pos = Vector( -5, 0, -5), 							-- Pos, Hard point location on the plane fuselage.
						Ang = Angle( 5, 0, 0 ), 								-- Ang, object angle
