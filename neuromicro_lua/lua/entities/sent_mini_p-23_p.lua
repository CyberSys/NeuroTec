...
ENT.Gauges = {
		AttitudeIndicator = {
			Pos = Vector( 15, 3.85, -.25 ),
			Ang = Angle(),
			Scale = 0.015
		};
		Compass = {
			Pos = Vector( 35, 15.45, -15.5 ),
			Ang = Angle(),
			Scale = 0.03
		};
		VSpeed = {
			Pos = Vector( 35, -.5, -6.25 ),
			Ang = Angle(),
			Scale = 0.03
		};
		Clock = {
			Pos = Vector( 35, 20, -15.0 ),
			Ang = Angle(),
			Scale = 0.02
		};		
		FuelCounter = {
			Pos = Vector( 35, 20, -21.0 ),
			Ang = Angle(),
			Scale = 0.02
		};
		Altimeter = {
			Pos = Vector( 35, 15.5, -6.25 ),
			Ang = Angle(),
			Scale = 0.03
		};
		Airspeed = {
			Pos = Vector( 35, 7.25, -15.5 ),
			Ang = Angle(),
			Scale = 0.03
		};		
		EngineTemp = {
			Pos = Vector( 35, -0.5, -15.5 ),
			Ang = Angle(),
			Scale = 0.03
		};
		Throttle = {
...
ENT.TailLiftMultiplier = 41        -- Wing Mass / Mult * Velocity -- lift coefficient 
ENT.WingLiftMultiplier = 58		    -- tail lift coefficient
ENT.MaxVelocity = 1.9 * 430			-- Top speed in km/h
