...
ENT.Gauges = {
		...
		VSpeed = {
			Pos = Vector( 35, -1.25, -1.70 ),
			Ang = Angle(),
			Scale = 0.025
		};
		Clock = {
			Pos = Vector( 35, 12, -10.0 ),
			Ang = Angle(),
			Scale = 0.02
		};
		Altimeter = {
			Pos = Vector( 35, 13.5, -1.5 ),
			Ang = Angle(),
			Scale = 0.025
		};
		Airspeed = {
			Pos = Vector( 35, 6.25, -10 ),
			Ang = Angle(),
			Scale = 0.025
		};		
		FuelCounter = {
...
ENT.WingLiftMultiplier = 43		    -- tail lift coefficient
ENT.MaxVelocity = 1.9 * 420			-- Top speed in km/h
...
ENT.BankForce = 370					-- Aileron / banking force Unit/s
