...
ENT.Gauges = {
		...
		VSpeed = {
			Pos = Vector( 35, -2.1, -12 ),
			Ang = Angle(),
			Scale = 0.02
		};
		Clock = {
			Pos = Vector( 35, -7.75, -13 ),
			Ang = Angle(),
			Scale = 0.015
		};
		Altimeter = {
...
ENT.BankForce = 600					-- Aileron / banking force Unit/s
