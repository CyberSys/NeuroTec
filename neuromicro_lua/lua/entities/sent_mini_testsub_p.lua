...
ENT.Type 				= "vehicle"
ENT.Base 				= "base_anim"
ENT.PrintName			= "USS Sturgeon LEVEL 1"
...
ENT.PropellerPos = { Vector( -82.5, 4.5, -7.7 ), 
						Vector( -82.5, -3.3, -7.7 ) }
ENT.PropellerModel = "models/neuronaval/starchick971/submarines/hms u class submarine_propeller.mdl"
