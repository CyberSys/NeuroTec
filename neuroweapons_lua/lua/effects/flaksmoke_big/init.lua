...
function EFFECT:Init( data )
	...
	for i=1, 14 do
		...
		local particle = emitter:Add( "particle/mat1", Pos + Vector( math.random( -50, 50 ) * 15, math.random( -50, 50 ) * 15, math.random( 10, 150 ) * 15 ) )
		...
		particle:SetStartSize( math.random( 60, 90 ) * 10 )
		particle:SetEndSize( math.random( 0, 10 ) * 10 )
	...
	for i=1, 15 do
		...
		local particle = emitter:Add( "particle/mat1", Pos + Vector( math.random( -150, 150 ) * 15, math.random( -150, 150 ) * 15, math.random( 20, 100 ) * 15 ) )
		...
		particle:SetStartSize( math.random( 40, 80 ) * 10 )
		particle:SetEndSize( math.random( 0, 10 ) * 10 )
		particle:SetRoll( math.random( -360, 360 ) )
