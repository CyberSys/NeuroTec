...
function ENT:Initialize()
	...
	if SERVER then
		...
		util.SpriteTrail( self, 0, Color( 0,155,0, 255 ), true, 4, 0, 1, math.sin(CurTime()) / math.pi * 0.5, "trails/smoke.vmt")
		
		-- self.ESound = CreateSound( self, "ambient/levels/citadel/citadel_ambient_scream_loop1.wav" )
		-- self.ESound:Play()
		
		local Glow = ents.Create("env_sprite")				
		Glow:SetKeyValue("model","sprites/poison/rad2.vmt")
		Glow:SetKeyValue("rendercolor","5 255 5")
		Glow:SetKeyValue("scale",tostring(.025))
		...
		Shine:SetKeyValue("rendercolor", "5 255 5")
...
function ENT:Draw()
	...
	edata:SetScale(10)
	util.Effect("neuro_radiation", edata)
