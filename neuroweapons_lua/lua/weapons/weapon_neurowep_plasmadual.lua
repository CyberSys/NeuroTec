...
if CLIENT then
   SWEP.PrintName = " dual M-27 Pulse Rifle"
   SWEP.Slot = 3
...
list.Add("NPCUsableWeapons", {class = "weapon_neurowep_plasmadual", title = SWEP.PrintName or ""});
...
SWEP.WorldModel = "models/weapons/w_dual_terminatorgun.mdl"
SWEP.Tracer = "tracerA"
...
local Pangles = self.Owner:EyeAngles()
local npcangles = self.Owner:GetAimVector()
