...
function SWEP:PenetrateThinSurfaceCallback( a,b,c, count )
	...
	if( !self.NoRicochet && ( DotProduct < .4 && count == 0 && ( b.MatType == MAT_CONCRETE || b.MatType == MAT_METAL ) ) || (  b.Entity:GetModel() == "models/arleitiss/riotshield/shield.mdl" || b.Entity:GetModel() == "models/bf4/bf4_shield.mdl" || b.Entity.BulletProof ) ) then 
