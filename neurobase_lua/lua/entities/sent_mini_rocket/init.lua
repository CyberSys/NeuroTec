...
function ENT:OnTakeDamage(dmginfo)
	...
	if( atk == self.Owner || atk.Owner == self.Owner ) then return end 
...
function ENT:OnRemove()
	...
	-- util.Effect( "RT_impact_mini", explo1 )
	-- util.Effect( "Explosion", explo1 )
	-- ParticleEffect( "Explosion", self:GetPos()+Vector(0,0,8), self:GetAngles()*-1, nil )
	ParticleEffect( "RT_impact_tank_mini", self:GetPos()+Vector(0,0,8), Angle(0,0,0), nil )
