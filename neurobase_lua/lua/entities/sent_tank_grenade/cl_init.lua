...
function ENT:EffectDraw_Fire()
	...
	if ( particle ) then
		...
		particle:SetEndSize( math.Rand( 11, 15 ) )
		particle:SetRoll( math.Rand(0, 360) )
		particle:SetRollDelta( math.Rand(-1, 1) )
		particle:SetColor( math.Rand(235,245), math.Rand(35,45), math.Rand(35,45) ) 
		particle:SetAirResistance( 100 ) 
		particle:SetGravity( VectorRand():GetNormalized()*math.Rand(5, 11)+Vector(0,0,math.Rand(5, 11)) ) 	
