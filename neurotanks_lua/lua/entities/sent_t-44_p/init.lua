...
self.AmmoTypes = { 
				...
				{
					PrintName = "85-mm ZiS-S-53 HE",
					Type = "sent_tank_shell",
					MinDmg = self.MinDamage-250,
					MaxDmg = self.MaxDamage-250,
					Radius = self.BlastRadius,
					Delay = self.PrimaryDelay,
					Sound = self.ShootSound,
				};
				{
					PrintName = "85-mm ZiS-S-53 APHE",
				...
				{
					PrintName = "85-mm  ZiS-S-53 SABOT",
