...
function ENT:Initialize()
	...
	self.BodygroupAmmo = 
	{
		{ 	-- First Body group loadout
			{
				PrintName = "75 mm AT Gun M7 L/50 AP",
				Type = "sent_tank_apshell",
				Delay = self.APDelay,
				Sound = self.ShootSound,
			};
			{
				PrintName = "75 mm AT Gun M7 L/50 APHE",
		...
		{	-- Incase you didnt't: 4th body group loadout
			{
				PrintName = "105 mm AT SPH M4 L23 AP",
				Type = "sent_tank_apshell",
				Delay = self.APDelay,
				Sound = self.ShootSound,
			};
			{
				PrintName = "105 mm AT SPH M4 L23 APHE",
				Type = "sent_tank_armorpiercing",
				Delay = self.PrimaryDelay,
				Sound = self.ShootSound,
			};
