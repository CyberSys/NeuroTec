ENT.FolderName = "sent_merkava_iv_p"

ENT.Type = "vehicle"
ENT.TankType = TANK_TYPE_HEAVY
ENT.Base = "base_anim"
ENT.PrintName	= "Merkava Mark IV"
ENT.Author	= "NeuroTec\nLua: Aftokinito\nRipping: Killstr3aKs"
...
ENT.TrackModels = { "models/killstr3aks/wot/israeli/merkava_iv_tracks_l.mdl","models/killstr3aks/wot/israeli/merkava_iv_tracks_r.mdl"  }
ENT.TrackWheels = { "models/killstr3aks/wot/israeli/merkava_iv_wheels_l.mdl","models/killstr3aks/wot/israeli/merkava_iv_wheels_r.mdl"  }
ENT.TrackAnimationOrder = { "models/killstr3aks/wot/israeli/merkava_iv/bat_chatillon25t_track", 
							"models/killstr3aks/wot/israeli/merkava_iv/bat_chatillon25t_track_reverse", 
							"models/killstr3aks/wot/israeli/merkava_iv/bat_chatillon25t_track_forward" }
-- Smaller cannon 
...
ENT.StartupSound = Sound( "bf4/engines/merkava_startup.wav" )
ENT.EngineSounds = {"bf4/engines/merkava_engine.wav" }
ENT.ShutDownSound = "bf4/engines/merkava_stop.wav"
ENT.StartupDelay = 1.70 -- Seconds
...
ENT.Model = "models/killstr3aks/wot/israeli/merkava_iv_body.mdl"
ENT.TowerModel = "models/killstr3aks/wot/israeli/merkava_iv_turret.mdl"
ENT.TowerPos  = Vector( -22, 0, 67 )
--ENT.TowerPart = 1
ENT.BarrelModel = "models/killstr3aks/wot/israeli/merkava_iv_gun.mdl"
--ENT.BarrelPart = 0
ENT.BarrelPos = Vector( 47, 0, 80 )
ENT.BarrelLength = 220
ENT.MaxBarrelYaw = 25 -- Only works if HasTower is set to false
ENT.ForcedMagazineCount = 30


ENT.MGunModel = "models/killstr3aks/wot/israeli/merkava_iv_mG.mdl"
ENT.MGunPos = Vector( 60, 4.5, 100 )
...
ENT.HeadLights = {}
ENT.HeadLights.Lamps = {}
ENT.HeadLights.Pos = { Vector( 124, -62, 59 ), Vector( 124, 62, 59 ) }
