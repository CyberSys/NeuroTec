...
function ENT:SpawnFunction( ply, tr)
	...
	local ent = ents.Create( "sent_dpv_p" )
	ent:SetPos( SpawnPos )
...
function ENT:Initialize()
	...
	self.Hummer:SetKeyValue("vehiclescript", "scripts/vehicles/neuro_dpv.txt")
	self.Hummer:Spawn()
	...
	self.Pod:SetModel( "models/l4d2_50cal_hack.mdl" )
	self.Pod:SetPos( self.Hummer:LocalToWorld( Vector( 0,-11,72 ) ) )
	...
	self.SeatPos = { Vector( 13, -5, 12 ), Vector( 0, -46.5, 34 ) }
	self.Seats = {}
	self.MGuns = {}
	...
	self.Seats[2].MountedWeapon = self.Pod
	self.Seats[2].isChopperGunnerSeat = true
