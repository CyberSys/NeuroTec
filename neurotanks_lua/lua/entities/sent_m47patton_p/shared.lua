...
ENT.FolderName = "sent_m47patton_p"
-- Used by hud stuff
ENT.Type = "vehicle"
-- base entity we derive from
ENT.Base = "base_anim"
-- Used by hud, menus etc.
ENT.PrintName	= "M47 Patton"
-- Your name goes here
...
ENT.BarrelMGunPos = Vector( -0, -9, 4 )
...
-- Barrle model
ENT.BarrelModel = "models/m47 patton/m47 gun.mdl"
-- Barrel pos relative to body
ENT.BarrelPos = Vector( 79, 0, 81.75 )
