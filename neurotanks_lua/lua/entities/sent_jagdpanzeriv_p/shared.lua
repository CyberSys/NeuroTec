ENT.FolderName = "sent_jagdpanzeriv_p"

ENT.Type = "vehicle"
ENT.TankType = TANK_TYPE_SUPERHEAVY
ENT.Base = "base_anim"
ENT.PrintName	= "JagdPanzerIV"
...
ENT.TrackModels = { 
						"models/wot/germany/jagdpanzeriv/jgpzivtracks_l.mdl",
						"models/wot/germany/jagdpanzeriv/jgpzivtracks_r.mdl"  
						}
ENT.TrackAnimationOrder = { "models/wot/german/tracks/pziv_ausfh_track", 
							"models/wot/german/tracks/pziv_ausfh_track_forward", 
							"models/wot/german/tracks/pziv_ausfh_track_reverse" }
...
ENT.Model = "models/wot/germany/jagdpanzeriv/jgpzivbody.mdl"
ENT.TowerModel = "models/wot/germany/jagdpanzeriv/jgpzivgun.mdl"
ENT.TowerPos  = Vector( 70, -9, 60 )
ENT.BarrelModel = "models/wot/germany/jagdpanzeriv/jgpzivgun.mdl"
ENT.BarrelPos = Vector( 55, -8.500, 58  )
