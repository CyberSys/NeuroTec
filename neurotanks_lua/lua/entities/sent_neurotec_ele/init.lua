...
function ENT:SpawnFunction( ply, tr, class )
	...
	if( !IsValid( ply.NeuroNuke ) ) then
		...
		ply:PrintMessage( HUD_PRINTCENTER, "You have to wait 75 million years before eradicating all life on earth again." )
...
function ENT:DoExplosion()
	...
	for j=1,30 do
		...
		tr.endpos = tr.start + Vector( math.random( -1028, 1028 ), math.random( -1028, 1028 ), math.random(-1512,1512) )
