...
function ENT:Initialize()
	...
	self.head:SetPos( self:GetPos() + Vector( 0, -1, 277 ) ) 
	self.head:SetAngles( self.Tower[1]:GetAngles() )
	self.head:SetModel( "models/inaki/props_vehicles/terminator_tankhk_head.mdl" )
