ENT.FolderName = "sent_amx13 90_p"
ENT.Type = "vehicle"
ENT.TankType = TANK_TYPE_LIGHT
ENT.Base = "base_anim"
ENT.PrintName	= "AMX13 90"
ENT.Author	= "NeuroTec\nLua: Hoffa and prof. heavy\nModel Adaption: Professor heavy"
ENT.Category 		= "NeuroTec Tanks - Light Tanks Tier VIII";
...
ENT.CamUp = 75
-- Cockpitview Vector
ENT.CockpitPosition = Vector(  20, 10, 35 )
...
-- Tank Body Model
ENT.Model = "models/wot/france/amx13 90/amx13 90body.mdl"
-- Tank Tower Model
ENT.TowerModel = "models/wot/france/amx13 90/amx13 90turret.mdl"
ENT.TowerPart = 0
-- Tower pos 
ENT.TowerPos  = Vector( -20, 1, 20.500 )

-- Pilot seat position
ENT.SeatPos = Vector( 0, 0, -10)

-- Barrel model
ENT.BarrelModel = "models/wot/france/amx13 90/amx13 90gun.mdl"
ENT.BarrelPart = 2
-- Position relative to tower
ENT.BarrelPos = Vector( -21, -1,21 )
...
ENT.TrackModels = { 
						"models/wot/france/amx13 90/amx13 90tracks_l.mdl",
						"models/wot/france/amx13 90/amx13 90tracks_r.mdl"  
						}
...
ENT.HeadLights.Pos = { Vector(  80, 28, 19 ),
Vector( 80, -30, 19 )
 }
