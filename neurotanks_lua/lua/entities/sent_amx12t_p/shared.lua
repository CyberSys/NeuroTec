ENT.FolderName = "sent_amx12t_p"
ENT.Type = "vehicle"
ENT.TankType = TANK_TYPE_LIGHT
ENT.Base = "base_anim"
ENT.PrintName	= "AMX 12 t"
ENT.Author	= "NeuroTec\nLua: Hoffa and prof. heavy\nModel Adaption: Professor heavy"
ENT.Category 		= "NeuroTec Tanks - Light Tanks Tier VI";
...
ENT.CamUp = 75
-- Cockpitview Vector
ENT.CockpitPosition = Vector(  20, 0, 17 )
...
-- Tank Body Model
ENT.Model = "models/wot/france/amx12t/amx12body.mdl"
-- Tank Tower Model
ENT.TowerModel = "models/wot/france/amx12t/amx12turret.mdl"
ENT.TowerPart = 0
-- Tower pos 
ENT.TowerPos  = Vector( 5, -0, 18 )

-- Pilot seat position
ENT.SeatPos = Vector( 0, 0, -10)

-- Barrel model
ENT.BarrelModel = "models/wot/france/amx12t/amx12gun.mdl"
ENT.BarrelPart = 2
-- Position relative to tower
ENT.BarrelPos = Vector( -10, -1,40 )
...
ENT.TrackModels = { 
						"models/wot/france/amx12t/amx12tracks_l.mdl",
						"models/wot/france/amx12t/amx12tracks_r.mdl"  
						}

ENT.TrackAnimationOrder = { "models/wot/french/amx12t/amx12_track", 
							"models/wot/french/amx12t/amx12_track_forward", 
							"models/wot/french/amx12t/amx12_track_reverse"	}
-- Secondary Weapon
...
ENT.HeadLights.Pos = { Vector( 106, 28, 19 ),
Vector( 106, -30, 19 )
 }
