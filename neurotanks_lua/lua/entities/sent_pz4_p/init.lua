...
function ENT:Initialize()
	...
	self.BodygroupAmmo = 
	{
		{ 	-- First Body group loadout
			{
				PrintName = "75 mm KwK 37 L/24 AP",
				Type = "sent_tank_apshell",
				Delay = self.APDelay,
				Sound = self.ShootSound,
			};
			{
				PrintName = "75 mm KwK 37 L/24 HE",
		...
		{	-- Second boydgroup loadout
			{
				PrintName = "50 mm KwK 39 L/60 AP",
				Type = "sent_tank_apshell",
				Delay = self.APDelay,
				Sound = self.ShootSound,
			};
		...
		{	-- I think you get it by now.
			{
				PrintName = "75 mm KwK 40 L/43 AP",
				Type = "sent_tank_apshell",
				Delay = self.APDelay,
				Sound = self.ShootSound,
			};
			{
				PrintName = "75 mm KwK 40 L/43 HE",
				Type = "sent_tank_shell",
				Delay = self.PrimaryDelay,
				Sound = self.ShootSound,
			};
		...
		{	-- Incase you didnt't: 4th body group loadout
			{
				PrintName = "75 mm KwK 40 L/48 AP",
				Type = "sent_tank_apshell",
				Delay = self.APDelay,
				Sound = self.ShootSound,
			};
			{
				PrintName = "75 mm KwK 40 L/48 HE",
				Type = "sent_tank_shell",
				Delay = self.PrimaryDelay,
				Sound = self.ShootSound,
			};
