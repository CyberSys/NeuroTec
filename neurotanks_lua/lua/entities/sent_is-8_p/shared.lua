...
ENT.TrackPositions = {Vector( 0, 0 ,0 ),Vector( 0, -100 ,0 ) }
-- Models used.
ENT.TrackModels = {  "models/killstr3aks/wot/russian/is-8_lsuspension.mdl", "models/killstr3aks/wot/russian/is-8_lsuspension.mdl" }
-- ENT.TrackWheels =  { "models/killstr3aks/wot/russian/is-8_suspension.mdl","models/killstr3aks/wot/russian/is-8_suspension.mdl"  }
ENT.PrototypeSuspension = false 
-- Texture animation order: First = Idle, Second = Forward, Third = Reverse
ENT.TrackAnimationOrder = { "models/killstr3aks/wot/russian/is-8/kv-1s_track", 
							"models/killstr3aks/wot/russian/is-8/kv-1s_track_forward", 
							"models/killstr3aks/wot/russian/is-8/kv-1s_track_reverse" }

-- Will randomize skin on spawn if >1
ENT.SkinCount = 1
-- Smaller cannon, barrel machinegun
ENT.BarrelMGunPos = Vector( -16, 10.5, 2.5 )
...
ENT.HeadLights.Pos = {Vector( 93, 30, 58 ),Vector( 93, -30, 58 ) }
-- Angle correction
...
-- Body/Hull Model
ENT.Model = "models/killstr3aks/wot/russian/is-8_body.mdl"
-- Tower Model
ENT.TowerModel = "models/killstr3aks/wot/russian/is-8_turret.mdl"
-- Tower Pos relative to body
ENT.TowerPos  = Vector( 34, 0 , 59 )
-- Barrle model
ENT.BarrelModel = "models/killstr3aks/wot/russian/is-8_gun.mdl"
