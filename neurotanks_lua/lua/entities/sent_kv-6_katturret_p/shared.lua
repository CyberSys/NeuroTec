...
ENT.MicroTurretPositions = {Vector( -73, 0, 30 )}
ENT.MicroTurretModels = { "models/killstr3aks/wot/russian/kv-6_launcher.mdl"}
ENT.MicroTurretAngles = { Angle( 0,0,0 )}
ENT.MicroTurretAmmo = "sent_autocannon_shell"
ENT.MicroTurretDelay = 0.35
ENT.MicroTurretEnt = "sent_kv-6_launcher_p"
...
ENT.TowerModel = "models/killstr3aks/wot/russian/kv-6_katturret.mdl"
